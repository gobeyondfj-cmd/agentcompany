...
from agentcompany.config import LLMConfig
from agentcompany.llm.base import BaseLLMProvider

if TYPE_CHECKING:
    from agentcompany.config import LLMProviderConfig
...
_PROVIDER_FACTORIES: dict[str, str] = {
    "anthropic": "agentcompany.llm.anthropic.AnthropicProvider",
    "openai": "agentcompany.llm.openai.OpenAIProvider",
}
